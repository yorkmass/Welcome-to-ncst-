<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xl.aspx.cs" Inherits="college_xl" %>
...
<!-- 侧滑菜单 -->
  <div id="wrapper">
    ...
    <div>
            <img src="../img/xx/xl.jpg" width="100%"  />
            <img src="../img/xx/xl1.jpg" width="100%"  />
           <img src="../img/xx/xl2.jpg" width="100%"  />
        </div>
