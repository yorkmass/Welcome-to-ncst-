<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xx.aspx.cs" Inherits="college_xx" %>
...
<!-- 侧滑菜单 -->
  <div id="wrapper">
    ...
    <div>
            <img src="../img/xx/xxc.jpg" width="100%"  />
            <img src="../img/xx/xxc1.jpg" width="100%"  />
           <img src="../img/xx/xxc2.jpg" width="100%"  />
        </div>
